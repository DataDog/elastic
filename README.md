...
**This is a fork of https://github.com/DataDog/elastic to be dep-compatible**
...
[![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/DataDog/elastic/master/LICENSE)

See the [wiki](https://github.com/DataDog/elastic/wiki) for additional information about Elastic.
...
**The release branches (e.g. [`release-branch.v7`](https://github.com/DataDog/elastic/tree/release-branch.v7))
...
----------------------|------------------|-------------|---------|
7.x                   | 7.0              | [`github.com/DataDog/elastic`](https://github.com/DataDog/elastic) ([source](https://github.com/DataDog/elastic/tree/release-branch.v7) [doc](http://godoc.org/github.com/DataDog/elastic)) | Use Go modules.
6.x                   | 6.0              | [`github.com/DataDog/elastic`](https://github.com/DataDog/elastic) ([source](https://github.com/DataDog/elastic/tree/release-branch.v6) [doc](http://godoc.org/github.com/DataDog/elastic)) | Use a dependency manager (see below).
5.x                   | 5.0              | [`gopkg.in/DataDog/elastic.v5`](https://gopkg.in/DataDog/elastic.v5) ([source](https://github.com/DataDog/elastic/tree/release-branch.v5) [doc](http://godoc.org/gopkg.in/DataDog/elastic.v5)) | Actively maintained.
2.x                   | 3.0              | [`gopkg.in/DataDog/elastic.v3`](https://gopkg.in/DataDog/elastic.v3) ([source](https://github.com/DataDog/elastic/tree/release-branch.v3) [doc](http://godoc.org/gopkg.in/DataDog/elastic.v3)) | Deprecated. Please update.
1.x                   | 2.0              | [`gopkg.in/DataDog/elastic.v2`](https://gopkg.in/DataDog/elastic.v2) ([source](https://github.com/DataDog/elastic/tree/release-branch.v2) [doc](http://godoc.org/gopkg.in/DataDog/elastic.v2)) | Deprecated. Please update.
0.9-1.3               | 1.0              | [`gopkg.in/DataDog/elastic.v1`](https://gopkg.in/DataDog/elastic.v1) ([source](https://github.com/DataDog/elastic/tree/release-branch.v1) [doc](http://godoc.org/gopkg.in/DataDog/elastic.v1)) | Deprecated. Please update.
...
```go
import "github.com/DataDog/elastic"
```
...
We will use this as an opportunity to [clean up and refactor Elastic](https://github.com/DataDog/elastic/blob/release-branch.v7/CHANGELOG-7.0.md),
...
and we used this as an opportunity to [clean up and refactor Elastic](https://github.com/DataDog/elastic/blob/release-branch.v6/CHANGELOG-6.0.md)
...
and we used this as an opportunity to [clean up and refactor Elastic](https://github.com/DataDog/elastic/blob/release-branch.v5/CHANGELOG-5.0.md)
...
Elastic 3.0 targets Elasticsearch 2.x and is published via [`gopkg.in/DataDog/elastic.v3`](https://gopkg.in/DataDog/elastic.v3).

Elastic 3.0 will only get critical bug fixes. You should update to a recent version.

### Elastic 2.0

Elastic 2.0 targets Elasticsearch 1.x and is published via [`gopkg.in/DataDog/elastic.v2`](https://gopkg.in/DataDog/elastic.v2).
...
versions.
We recently switched to [GitHub Actions for testing](https://github.com/DataDog/elastic/actions).
Before that, we used [Travis CI](https://travis-ci.org/DataDog/elastic) successfully for years).
...
The first thing you do is to create a [Client](https://github.com/DataDog/elastic/blob/master/client.go).
...
An example is available [here](https://DataDog.github.io/elastic/).

Here's a [link to a complete working example for v6](https://gist.github.com/DataDog/e4a376b4783c0914e44ea4f745ce2ebf).

Here are a few tips on how to get used to Elastic:

1. Head over to the [Wiki](https://github.com/DataDog/elastic/wiki) for detailed information and
   topics like e.g. [how to add a middleware](https://github.com/DataDog/elastic/wiki/HttpTransport)
   or how to [connect to AWS](https://github.com/DataDog/elastic/wiki/Using-with-AWS-Elasticsearch-Service).
...
3. The [recipes](https://github.com/DataDog/elastic/tree/release-branch.v6/recipes)
...
A pattern for [efficiently scrolling in parallel](https://github.com/DataDog/elastic/wiki/ScrollParallel)
is described in the [Wiki](https://github.com/DataDog/elastic/wiki).

## How to contribute

Read [the contribution guidelines](https://github.com/DataDog/elastic/blob/master/CONTRIBUTING.md).
